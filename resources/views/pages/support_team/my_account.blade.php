                            ...
                            <div class="col-md-6">
                                <form enctype="multipart/form-data" method="post" action="{{ route('my_account.update') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="name" name="name" class="form-control" type="text" value="{{ old('name', $my->name) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="username" name="username" class="form-control" type="text" value="{{ old('username', $my->username) }}" required>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="email" class="col-lg-3 col-form-label font-weight-semibold">Email <span class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <input id="email" name="email" class="form-control" type="email" value="{{ old('email', $my->email) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            @if ($errors->has('photo'))
                                                <div class="text-danger mb-2">{{ $errors->first('photo') }}</div>
                                            @endif
