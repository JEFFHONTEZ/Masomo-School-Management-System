...
class UserController extends Controller
{
    ...
    public function teachers()
    {
        ...
        return view('pages.support_team.users.teacher', compact('teachers'));
    }

    public function admins()
    {
        $admins = \App\User::where('user_type', 'admin')->get();
        return view('pages.support_team.users.admin', compact('admins'));
    }

    public function parents()
    {
        $parents = \App\User::where('user_type', 'parent')->get();
        return view('pages.support_team.users.parents', compact('parents'));
    }
