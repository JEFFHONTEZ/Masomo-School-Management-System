   ...
   public function __construct(LocationRepo $loc, MyClassRepo $my_class, UserRepo $user, StudentRepo $student)
   {
    ...
    public function store(StudentRecordCreate $req)
    {
       ...
       /* $ct = ($ct == 'J') ? 'JSS' : $ct;
        ...
        $adm_no = $req->adm_no;
        $year_short = substr($sr['year_admitted'], -2);
    ...
    public function edit($sr_id)
    {
        ...
        // Add this check:
        if(!$data['sr'] || !$data['sr']->user){
            return redirect()->route('students.index')->with('pop_error', 'Student record not found.');
        }
    ...
    {
        // Fetch all students (adjust as needed for your app)
        $students = \App\User::where('user_type', 'student')->get();

        // Return a view and pass the students
        return view('pages.support_team.students.index', compact('students'));
    }
