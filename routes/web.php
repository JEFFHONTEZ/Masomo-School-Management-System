...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'SupportTeam',], function(){
        ...
        Route::group(['prefix' => 'users'], function(){
            ...
            Route::get('/teachers', [App\Http\Controllers\SupportTeam\UserController::class, 'teachers'])->name('users.teachers');
            Route::get('/admins', [App\Http\Controllers\SupportTeam\UserController::class, 'admins'])->name('users.admins');
            Route::get('/parents', [App\Http\Controllers\SupportTeam\UserController::class, 'parents'])->name('users.parents');
        });
...
Route::group(['namespace' => 'MyParent','middleware' => 'my_parent',], function(){
    ...
    Route::get('/parent/invoice/{id}/{year?}', [\App\Http\Controllers\SupportTeam\PaymentController::class, 'invoice'])->name('parent.payments.invoice');
});
